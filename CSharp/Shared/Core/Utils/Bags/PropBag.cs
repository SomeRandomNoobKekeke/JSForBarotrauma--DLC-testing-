...
namespace JSForBarotrauma
{
  ...
  /// <summary>
  /// It's like PropertyBag but instead of values it contains Props with Getters and Setters
  /// </summary>
  public class PropBag : IPropertyBag
  {
    public class Prop
    {
    ...
    public Dictionary<string, Prop> Props { get; set; } = new();
    ...
    public PropBag() { }
    public PropBag(Dictionary<string, Prop> props) => Props = props;
